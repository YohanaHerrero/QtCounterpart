...
image_Widgeti(), main_image_Widget(), image_Widget_narrowband_muse(): cut the relevant area of the small HST band i and display it. Same for the main HST image and the MUSE NB image
